#!/bin/bash
#SBATCH --job-name=spindle_xenium_human_lymph_node
...
echo -e "Setting up virtual environment for processing /data/sarkar_lab/insitupy_demo_data_xenium/xenium_human_lymph_node.h5ad...\n\n"
...
echo -e "Processing /data/sarkar_lab/insitupy_demo_data_xenium/xenium_human_lymph_node.h5ad...\n\n"
