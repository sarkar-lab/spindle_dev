#!/bin/bash
#SBATCH --job-name=spindle_xenium_human_breast_cancer
...
echo -e "Setting up virtual environment for processing /data/sarkar_lab/insitupy_demo_data_xenium/xenium_human_breast_cancer.h5ad...\n\n"
...
echo -e "Processing /data/sarkar_lab/insitupy_demo_data_xenium/xenium_human_breast_cancer.h5ad...\n\n"
